...
from .commands.background_processes import add_queue_parser
from .commands.background_processes import add_status_parser
from .commands.background_processes import (  # noqa: F401
    handle_queue_command,
    handle_status_command,
)
from .commands.crawl import add_crawl_parser
from .commands.crawl import handle_crawl_command  # noqa: F401
from .commands.discovery import add_discovery_parser
from .commands.discovery import (  # noqa: F401
    handle_discovery_command,
)
from .commands.discovery_report import add_discovery_report_parser
from .commands.discovery_report import (  # noqa: F401
    handle_discovery_report_command,
)
from .commands.extraction import add_extraction_parser
from .commands.extraction import (  # noqa: F401
    handle_extraction_command,
)
from .commands.gazetteer import add_gazetteer_parser
from .commands.gazetteer import handle_gazetteer_command  # noqa: F401
from .commands.http_status import add_http_status_parser
from .commands.http_status import (  # noqa: F401
    handle_http_status_command,
)
from .commands.list_sources import add_list_sources_parser
from .commands.list_sources import (  # noqa: F401
    handle_list_sources_command,
)
from .commands.load_sources import add_load_sources_parser
...
from .commands.verification import add_verification_parser
from .commands.verification import (  # noqa: F401
    handle_verification_command,
)
from .commands.versioning import add_versioning_parsers
...
def main(
    ...
    *,
    setup_logging_func: Optional[Callable[[str], None]] = None,
    handler_overrides: Optional[Dict[str, CommandHandler]] = None,
) -> int:
