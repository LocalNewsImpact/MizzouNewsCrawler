...
COMMAND_HANDLER_ATTRS: dict[str, str] = {
    ...
    "backfill-verifications": "handle_verification_backfill_command",
    "check-ingested": "handle_ingest_check_command",
    "byline-report": "handle_byline_report_command",
    "backfill-telemetry-dataset": "handle_telemetry_dataset_backfill_command",
    "repair-byline-surnames": "handle_byline_surname_repair_command",
    "repair-rot47-bodies": "handle_rot47_body_repair_command",
    "geocode-gazetteer": "handle_gazetteer_geocode_command",
    "load-state-gazetteer": "handle_state_gazetteer_command",
    "gazetteer-place": "handle_manual_gazetteer_command",
    "refetch-articles": "handle_refetch_command",
    "rework-plan": "handle_rework_plan_command",
    "validate-login": "handle_validate_login_command",
    "rematch-entities": "handle_rematch_entities_command",
    "repair-link-status": "handle_link_status_repair_command",
    "align-wire-signal": "handle_wire_signal_alignment_command",
...
def _load_command_parser(command: str) -> tuple[Callable, Callable] | None:
    ...
    command_modules = {
        ...
        "backfill-verifications": "verification_backfill",
        "check-ingested": "ingest_check",
        "byline-report": "byline_report",
        "backfill-telemetry-dataset": "telemetry_dataset_backfill",
        "repair-byline-surnames": "byline_surname_repair",
        "repair-rot47-bodies": "rot47_body_repair",
        "geocode-gazetteer": "gazetteer_geocode",
        "load-state-gazetteer": "state_gazetteer",
        "gazetteer-place": "manual_gazetteer",
        "refetch-articles": "refetch",
        "rework-plan": "rework_plan",
        "validate-login": "validate_login",
        "rematch-entities": "rematch_entities",
        "repair-link-status": "link_status_repair",
        "align-wire-signal": "wire_signal_alignment",
        ...
        "front-controller-duplicates": "front_controller_duplicates",
