...
class ExtractionResult:
    ...
    author_count: Optional[int] = None  # Number of authors detected

    # Field quality tracking
    title_quality_issues: Optional[list] = None
    content_quality_issues: Optional[list] = None
    author_quality_issues: Optional[list] = None
    publish_date_quality_issues: Optional[list] = None
