...
from src.utils.comprehensive_telemetry import ComprehensiveExtractionTelemetry, ExtractionMetrics
...
class TestTelemetryTransactionRollback(unittest.TestCase):
    def test_comprehensive_telemetry_rollback_on_integrity_error(self):
        ...
        metrics = ExtractionMetrics(
            operation_id="op1", article_id="art1", url="http://test.com", publisher="test"
        )
