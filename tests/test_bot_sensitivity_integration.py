...
class TestContentExtractorBotSensitivityIntegration:
    ...
    def test_http_403_triggers_bot_detection(self, extractor_with_bot_sensitivity):
    ...
    def test_captcha_detection_triggers_recording(self, extractor_with_bot_sensitivity):
    ...
    def test_rate_limit_config_includes_all_required_fields(self):
        ...
        for sensitivity in range(1, 11):
            ...
            for field in required_fields:
                assert field in config, f"Sensitivity {sensitivity} missing {field}"
