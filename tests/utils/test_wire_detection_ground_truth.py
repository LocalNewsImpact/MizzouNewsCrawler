...
class TestWireDetectionGroundTruth:
    ...
    def test_ground_truth_validation(self, wire_detection_test_session, monkeypatch):
        ...
        wire_detection_rate = (wire_sample_size - len(wire_not_detected)) / wire_sample_size * 100
        ...
        # Ensure we're detecting wire articles reasonably well
        assert wire_detection_rate >= 80.0, (
