...
def test_record_counter_with_labels():
    ...
    client.record_counter("test_metric", 10, labels={"source": "example.com"})
...
def test_record_gauge_with_labels():
    ...
    client.record_gauge("test_gauge", 42.5, labels={"queue": "verification"})
...
def test_record_distribution_with_labels():
    ...
    client.record_distribution(
        "test_distribution", 1.234, labels={"stage": "extraction"}
    )
