...
class TestUserAgentImprovements:
    ...
    def test_user_agent_pool_size(self):
        ...
        assert len(extractor.user_agent_pool) >= 10, "Should have at least 10 user agents"
    ...
    def test_multiple_platforms(self):
        ...
        assert "Macintosh" in ua_text or "Mac OS X" in ua_text, "Should have macOS user agents"
