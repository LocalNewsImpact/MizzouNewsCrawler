...
class TestAMPTestSupport:
    ...
    def test_test_amp_support_invalid_amp(self, mock_mark, mock_session):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.text = '<html><body><p>Regular HTML content</p></body></html>' * 50
...
class TestAMPIntegration:
    ...
    def test_preemptive_amp_fetch_when_known_supported(self, mock_amp_support, mock_session):
        ...
        mock_amp_response.text = '<html amp><body><article><p>AMP content test</p></article></body></html>' * 50
    ...
    def test_amp_bypass_on_perimeterx_detection(self, mock_session, mock_detect):
        ...
        mock_amp_response = Mock()
        mock_amp_response.status_code = 200
        mock_amp_response.text = '<html amp><body><article><p>AMP content bypassed PerimeterX</p></article></body></html>' * 50
        mock_amp_response.elapsed.total_seconds.return_value = 0.5
