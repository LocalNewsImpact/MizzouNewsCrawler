Site Diagnostics Report - 2026-02-05 14:20:37 UTC
...
- Possible causes: Verified articles but extraction failed; No obvious feed endpoints detected
- Suggested fixes: Run extraction diagnostics from extraction pod; adjust bot protection handling; tune rate limits; Add sitemap-based discovery or scrape section pages with article detectors
...
- Possible causes: Discovery present but verification found no articles; URLs suppressed by wire filters; No obvious feed endpoints detected
- Suggested fixes: Tune StorySniffer and verification patterns; add allowlist for article paths; Review wire URL patterns and exclude local-only paths; Add sitemap-based discovery or scrape section pages with article detectors
...
- Possible causes: Discovery present but verification found no articles; No obvious feed endpoints detected
- Suggested fixes: Tune StorySniffer and verification patterns; add allowlist for article paths; Add sitemap-based discovery or scrape section pages with article detectors
